% Note that this header file must be included in each lecture *.tex file
% The following minimal structure is expected:
%.
%├── include
%│   ├── bibliography.bib        % shared bibliography
%│   ├── header-include.tex      % <--- this file
%│   ├── img
%│   │   ├── cc-by-sa-icon.pdf   % shared icons and logos
%│   │   ├── logo-rctrust.pdf
%│   │   ├── logo-trusthlt.pdf
%│   │   └── rub-logo.pdf
%│   └── README.md
%└── lectureXX
%    └── lectureXXX.tex          % <--- the main tex file to be compiled
%
% The compilation must happen in each "lectureXX" folder
...
\setbeamertemplate{frame numbering}{TrustHLT --- Prof.\ Dr.\ Ivan Habernal \hspace*{1ex} \includegraphics[width=7em]{../include/img/rub-logo.pdf}\hspace*{1ex}}
...
\titlegraphic{%
	\begin{picture}(0,0)
		\put(435,0){\makebox(0,0)[rt]{\includegraphics[width=7em]{../include/img/rub-logo.pdf}}}
		\put(435,-170){\makebox(0,0)[rt]{\includegraphics[width=4em]{../include/img/logo-trusthlt.pdf}}}
		\put(435,-196){\makebox(0,0)[rt]{\includegraphics[width=9em]{../include/img/logo-rctrust.pdf}}}
	\end{picture}%
}
