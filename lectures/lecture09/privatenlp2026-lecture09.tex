...
% Compact references: shrink the body font and tighten biblatex's large default
% inter-entry spacing so the bibliography fits in far fewer slides.
% Density knob -- change \scriptsize below: \tiny < \scriptsize < \footnotesize < \small.
