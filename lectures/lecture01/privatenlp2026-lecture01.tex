...
No graded homework assignments, but we will provide some optional assignments
...
We have a book draft\footnote{Ivan Habernal and Sepideh Ghanavati: Privacy-Preserving Methods in Natural Language Processing} submitted to Springer!

\begin{itemize}
\item Will share it on Moodle, not final and not public yet
\item Any sort of feedback will be much appreciated! (just tell me or e-mail me)
\end{itemize}
...
\begin{frame}{Contextual Integrity}

\emph{Contextual integrity} is a philosophical account of privacy in terms of the transfer of personal information

It is \textbf{not} proposed as a full definition of privacy, but as a normative model, for evaluating the flow of information between agents (individuals and other entities)

\begin{itemize}
\item CI characterizes privacy as appropriate information flow
\item three parameters: actors (subject, sender, recipient), information type, and transmission principles
\end{itemize}

Picked-up by some NLP research recently

\begin{tikzpicture}[overlay, remember picture]
\node at (current page.north east)[ref] {
\fullcite{Barth.et.al.2006.SP} \bigskip \newline \fullcite{Li.et.al.2025.NAACL.CI} \par};
\end{tikzpicture}
...
\begin{enumerate}
\item Download 108 bytes of data from Wikipedia, and generate prompts by randomly sampling hundreds of millions of continuous 5-token blocks from this dataset
